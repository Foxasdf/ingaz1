...
<body>
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-edit"></i> تعديل العملة</h1>
            ...
            <div class="card-body">
                <form action="{{ route('coins.update', $coin->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="coin" name="coin" value="{{ old('coin', $coin->coin) }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="coin_price" class="form-label">سعر العملة</label>
                        <input type="number" class="form-control" id="coin_price" name="coin_price" value="{{ old('coin_price', $coin->coin_price) }}" required>
                    </div>
