...
<div class="container mt-5">
    ...
    <form action="{{ route('calculations.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" id="رصيد_الدائن" name="رصيد الدائن" class="form-control" readonly>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" id="رصيد_المدين" name="رصيد المدين" class="form-control" readonly>
        </div>
        ...
        <div class="mb-3">
            <label for="ذمة" class="form-label">ذمة</label>
            <input type="number" id="ذمة" name="ذمة" class="form-control" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select id="passport" name="passport_id" class="form-control">
                @foreach($passports as $passport)
                    <option value="{{ $passport->id }}">{{ $passport['الاسم'] }}</option>
                @endforeach
            </select>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateAccountDropdown(accountTypeSelect, accountSelect) {
            ...
            if (accountTypeId) {
                fetch(`/accounts/by-type/${accountTypeId}`)
        ...
        // Event listeners for amount inputs and coin selection
